...
class Settings:
    ...
    # Points System
    HOST_COST_POINTS: int = int(os.getenv("HOST_COST_POINTS", 10))  # Points per hour
    MIN_POINTS_TO_HOST: int = int(os.getenv("MIN_POINTS_TO_HOST", 10))
    POINTS_PER_RUPEE: int = int(os.getenv("POINTS_PER_RUPEE", 10))
    UPI_ID: str = os.getenv("UPI_ID", "your-upi@upi")
