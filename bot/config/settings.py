...
class Settings:
    ...
    DAILY_POINT_COST: int = int(os.getenv("DAILY_POINT_COST", 2))  # Points deducted per day per bot
    MINIMUM_POINTS_FOR_DEPLOYMENT: int = int(os.getenv("MINIMUM_POINTS_FOR_DEPLOYMENT", 60))  # Minimum points to deploy
